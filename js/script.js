window.onload = function() {
    ...
    function init() {
        ...
        canvas.style.border = "solid 30px grey";
    ...
    function gameOver() {
        ...
        ctx.strokeText("Gamer Over", centerX, centerY-180);
        ctx.fillText("Gamer Over", centerX, centerY-180);
    ...
    function Apple(position) {
        ...
        this.isOnSnake = function(snakeToCheck) {
            ...
            for(i=0; snakeToCheck < snakeToCheck.body.length; i++) {
